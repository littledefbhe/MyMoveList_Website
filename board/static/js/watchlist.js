        ...
        uniqueButtons.forEach(button => {
            ...
            if (data.status === 'added to') {
                ...
                if (button.textContent.includes('Add to Watchlist')) {
                    ...
                    button.innerHTML = button.innerHTML.replace('bi-bookmark-plus', 'bi-bookmark-check-fill')
                                                     .replace('Add to Watchlist', 'In Watchlist');
                }
                ...
                if (button.textContent.includes('In Watchlist')) {
                    ...
                    // For the movie detail page button
                    button.innerHTML = button.innerHTML.replace('bi-bookmark-check-fill', 'bi-bookmark-plus')
                                                     .replace('In Watchlist', 'Add to Watchlist');
                }
